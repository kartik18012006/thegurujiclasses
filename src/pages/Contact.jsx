            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@thegurujiclasses.com</p>
                    <p className="text-gray-600">info@thegurujiclasses.com</p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="bg-gray-100 hover:bg-indigo-100 text-gray-700 hover:text-indigo-600 rounded-full p-3 transition"
                    aria-label="Facebook"
                  >
